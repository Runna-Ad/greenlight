...
// ── Higgsfield · paso 1: las familias que el equipo usa ahí + la página de cada modelo ──
{
  ...
  eq("costoMinimo: ilimitado = 0; Seedance = su Mini; DoP 7 (Turbo)", JSON.stringify([costoMinimo(CATALOGO_BASE, "seedream"), costoMinimo(CATALOGO_BASE, "seedance"), costoMinimo(CATALOGO_BASE, "higgsfield")]), "[0,12.5,7]");
