...
export async function guardarMiembro(
  ...
  // Grant multi-track (`tracks`, 0059): ahora de CUALQUIER doer — lead o creative. Un
  // especialista que trabaja Real y Normal ya no queda atado a uno (Pedro 2026-09-01).
  // Coherencia:
