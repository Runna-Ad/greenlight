...
export const UI = {
  ...
  pasoAPaso: t("Paso a paso en Higgsfield", "Step by step in Higgsfield"),
  ...
  comoSalioVideo: t("Para un video, sube el video (H.Ü.E toma el cuadro del medio) o una captura.", "For a video, upload the video (H.Ü.E takes the middle frame) or a screenshot."),
  ...
  subirResultadoVideo: t("Arrastra el video (o un cuadro) o búscalo en tu compu", "Drag the video (or a frame) or browse your files"),
  pegarResultado: t("…o cópiala en Higgsfield y pégala aquí con ⌘V / Ctrl+V", "…or copy it in Higgsfield and paste it here with ⌘V / Ctrl+V"),
  preparando: t("Preparando la imagen…", "Preparing the image…"),
  videoIlegible: t("No pude leer ese video en el navegador. Sube una captura de un cuadro.", "Couldn't read that video in the browser. Upload a screenshot of one frame."),
  imagenIlegible: t("No pude leer esa imagen. Prueba con JPG o PNG.", "Couldn't read that image. Try JPG or PNG."),
  tipoNoSoportado: t("Eso no es una imagen ni un video.", "That's not an image or a video."),
